...
@section('content')
	<div class="container" ng-controller="timeToHireCntrl">
		<h1>Time to Hire</h1>
		<div class="row">
        					...
        					<div class="col-md-4">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Avg. time to hire <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
    					...
    					<div class="row">
    						<div class="table-responsive">
                      			<table class="table table-hover table-condensed table-detailed" id="detailedTable">
			                        ...
			                        <tbody>
				                        <tr ng-repeat="data in data.timetohire">
					                        <td class="v-align-middle">@{{ data['job_title'] }}</td>
					                        <td class="v-align-middle">@{{ data['count'] }}</td>
					                        <td class="v-align-middle semi-bold">Count</td>
...
@section('scripts')
	<script type="text/javascript">
		app.controller('timeToHireCntrl', function($scope,$http){
			$scope.data = {};
			$scope.data.timetohire = {!! json_encode($timetohire) !!};
