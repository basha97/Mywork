...
@section('content')
	<div class="container" ng-controller="candidateorigin">
		<h1>Candidate Origins</h1>
		<div class="row">
        					...
        					<div class="col-md-3">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            ...
							            <div class="p-l-20">
							                <h3 class="no-margin p-b-5 text-white">@{{ data.job_application.length }}</h3>
							            </div>
						            </div>
						        </div>
        					</div>
        					...
        					<div class="col-md-3">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Added <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
        					...
        					<div class="col-md-3">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Sourced <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
    					...
    					<div class="row">
    						<div class="table-responsive">
                      			<table class="table table-hover table-condensed table-detailed" id="detailedTable">
			                        ...
			                        <tbody>
				                        <tr ng-repeat="data in data.candidateorigin">
...
@section('scripts')
	<script type="text/javascript">
		app.controller('candidateorigin', function($scope,$http){
			$scope.data = {};
			$scope.data.candidateorigin = {!! json_encode($candidateorigin) !!};
			console.log($scope.data.candidateorigin);
