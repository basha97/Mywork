...
@section('content')
	<div class="container" ng-controller="canProgressCntrl">
	                            ...
	                            <form class="">
	                                <div class="card-body row no-gutters align-items-center">
	                                    <div class="col">
	                                        ...
	                                        <input class="form-control form-control-lg form-control-borderless" ng-model="searchTxt" type="search" placeholder="Search topics or keywords">
	                                    </div>
	                                </div>
	                            </form>
	                        </div>
						        ...
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                ...
							                <span class="font-montserrat fs-11 all-caps">Total candidates <i
							            ...
							            <div class="p-l-20">
							                <h3 class="no-margin p-b-5 text-white">@{{ data.jobApplication.length }}</h3>
							            </div>
						            </div>
						        </div>
        					</div>
        					...
        					<div class="col-md-3">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Disqualified <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
							            ...
							            <div class="p-l-20">
							                <h3 class="no-margin p-b-5 text-white">0</h3> 
							            </div>   
						            </div>
						        </div>
        					</div>
        					...
        					<div class="col-md-3">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Interview stage <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
        					...
        					<div class="col-md-3">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Hire stage <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
    					...
    					<div class="row">
    						<div class="table-responsive">
                      			<table class="table table-hover table-condensed table-detailed" id="detailedTable">
			                        ...
			                        <tbody>
				                        <tr ng-repeat="data in data.overallCount | filter : searchTxt">
					                        <td class="v-align-middle">@{{ data['job_title'] }}</td>
					                        <td class="v-align-middle">@{{ data['count'] }}</td>
					                        <td class="v-align-middle semi-bold"> Count Function </td>
...
@section('scripts')
	<script type="text/javascript">
		app.controller('canProgressCntrl', function($scope,$http){
			$scope.data = {};
			$scope.data.jobApplication = {!! json_encode($job_application) !!};
			
			$scope.data.overallCount = {!! json_encode($overallCount) !!};
			
			$scope.data.department = {!! json_encode($department) !!};

			$scope.data.departmentCount = {!! json_encode($departmentCount) !!};
			console.log($scope.data.departmentCount);
		})
	</script>
@endsection