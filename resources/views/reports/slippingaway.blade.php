...
@section('content')
	<div class="container" ng-controller="slipCntrl">
		<h1>Slipping Away</h1>
		<div class="row">
        					...
        					<div class="col-md-4">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Contacted <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
        					...
        					<div class="col-md-4">
						        <div class="widget-9 card no-border bg-primary no-margin widget-loader-bar">
						            <div class="full-height d-flex flex-column">
							            <div class="card-header ">
							                <div class="card-title text-black">
							                <span class="font-montserrat fs-11 all-caps">Not Contacted <i
							            class="fa fa-chevron-right"></i>
							                </span>
							                </div>
							                <div class="card-controls">
    					...
    					<div class="row">
    						<div class="table-responsive">
                      			<table class="table table-hover table-condensed table-detailed" id="detailedTable">
			                        ...
			                        <tbody>
				                        <tr ng-repeat="data in data.slippingaway">
...
@section('scripts')
	<script type="text/javascript">
		app.controller('slipCntrl', function($scope,$http){
			$scope.data = {};
			$scope.data.slippingaway = {!! json_encode($slippingaway) !!};
