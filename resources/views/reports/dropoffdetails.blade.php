...
@section('content')
	<div class="container" ng-controller="dropCntrl">
    					...
    					<div class="row">
    						<div class="table-responsive">
                      			<table class="table table-hover table-condensed table-detailed" id="detailedTable">
			                        ...
			                        <tbody>
				                        <tr ng-repeat="data in data.dropoffdetails">
...
@section('scripts')
	<script type="text/javascript">
		app.controller('dropCntrl', function($scope,$http){
			$scope.data = {};
			$scope.data.dropoffdetails = {!! json_encode($dropoffdetails) !!};
