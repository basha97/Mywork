...
@section('content')
	<div class="container" ng-controller="ProceedCntrl">
		<h1>Proceeded Details</h1>
		<div class="row">
    					...
    					<div class="row">
    						<div class="table-responsive">
                      			<table class="table table-hover table-condensed table-detailed" id="detailedTable">
			                        ...
			                        <tbody>
				                        <tr ng-repeat="data in data.proceeddetails">
...
@section('scripts')
	<script type="text/javascript">
		app.controller('ProceedCntrl', function($scope,$http){
			$scope.data = {};
			$scope.data.proceeddetails = {!! json_encode($proceeddetails) !!};
