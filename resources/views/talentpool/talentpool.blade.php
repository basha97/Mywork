			...
			{{-- Adding The talent pool part1 --}}
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group">
                                ...
                                <textarea ck-editor cols="80" class="form-control"  rows="10"  ng-model="description">
                                </textarea>
                            </div>            
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="container save_tal">
						...
						<div class="row">
							<div class="col-md-12">
								<a class="btn btn-primary btn-block save_but" href="javascript:;" ng-click="saveData()">Save</a>
							</div>
						</div>
					</div>
				</div>
